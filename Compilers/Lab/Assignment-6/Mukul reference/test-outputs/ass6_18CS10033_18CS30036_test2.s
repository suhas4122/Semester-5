...
.STR0:	.string "Number of numbers: \n"
.STR1:	.string "Enter the numbers (separated by newlines): \n"
.STR2:	.string "The sorted elements are:\n"
.STR3:	.string " "
.STR4:	.string "\n"
	.text
	.globl	merge
...
# 173:res = t096 arg1 = i 
	...
	imull	%ecx, %eax
	movl	%eax, -464(%rbp)
# 174:res = t095 arg1 = t094 arg2 = t096 
	movl	-456(%rbp), %eax
	movl	-464(%rbp), %edx
	addl	%edx, %eax
	movl	%eax, -460(%rbp)
# 175:res = t097 arg1 = err 
	leaq	-416(%rbp), %rax
	movq	%rax, -468(%rbp)
# 176:res = t097 
# 177:res = t098 
	...
	movl	%eax, -472(%rbp)
	addq $0 , %rsp
# 178:res = a arg1 = t095 arg2 = t098 
	leaq	-400(%rbp), %rdx
	movslq	-460(%rbp), %rax
	addq	%rax, %rdx
	movl	-472(%rbp), %eax
	movl	%eax, (%rdx)
# 179:res = t099 arg1 = t098 
	movl	-472(%rbp), %eax
	movl	%eax, -476(%rbp)
# 180:
	jmp .L28
...
# 201:res = t111 arg1 = i 
	...
	imull	%ecx, %eax
	movl	%eax, -524(%rbp)
# 202:res = t110 arg1 = t109 arg2 = t111 
	movl	-516(%rbp), %eax
	movl	-524(%rbp), %edx
	addl	%edx, %eax
	movl	%eax, -520(%rbp)
# 203:res = t112 arg1 = a arg2 = t110 
	leaq	-400(%rbp), %rdx
	movslq	-520(%rbp), %rax
	addq	%rax, %rdx
	movl	(%rdx), %eax
